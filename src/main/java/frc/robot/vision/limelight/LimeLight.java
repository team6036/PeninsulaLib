...
public class LimeLight {
    ...
    public ControlLime.LedMode getLEDMode() {
        ...
        ControlLime.LedMode mode = ControlLime.LedMode.getByValue(led);
        return mode;
    }
    ...
    public void setCamMode(ControlLime.CamMode camMode) {
    ...
    public ControlLime.CamMode getCamMode() {
        ...
        ControlLime.CamMode mode = ControlLime.CamMode.getByValue(cam);
        return mode;
    }
     ...
     * @param stream
     */
    public void setStream(ControlLime.StreamType stream) {
        m_table.getEntry("stream").setValue(stream.getValue());
    }

    public ControlLime.StreamType getStream() {
        NetworkTableEntry stream = m_table.getEntry("stream");
        double st = stream.getDouble(0.0);
        ControlLime.StreamType mode = ControlLime.StreamType.getByValue(st);
        return mode;
    }
    ...
    public double getAdvanced_RawCrosshair_Y(ControlLime.Advanced_Crosshair raw) {
